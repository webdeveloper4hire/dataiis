...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm1" value="PAR" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Category:</td>
      <td><input type="text" name="tb1_colunm2" value="" size="32" required list="category" />
      <datalist id="category">
        ...
        <option>Tech and Scientific Equipment</option>
        <option>Other Machineries and Equipment</option>
	   </datalist>      
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Fund Cluster:</td>
      <td><input type="text" name="tb1_colunm20" value="" size="32" required list="fund"/>
      <datalist id="fund">
  		<option>101</option>
        <option>158</option>
        <option>102</option>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm3" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Property Number:</td>
      <td><input type="text" name="tb1_colunm4" value="<?php echo $_GET['tb1_colunm4']; ?>" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date Aquired:</td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm7" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unit Measure:</td>
      <td><input type="text" name="tb1_colunm8" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unit Value:</td>
      <td><input type="text" name="tb1_colunm9" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Quantity(Card):</td>
      <td><input type="text" name="tb1_colunm10" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Quantity(Physical):</td>
      <td><input type="text" name="tb1_colunm11" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Amount:</td>
      <td><input type="text" name="tb1_colunm12" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Received by:</td>
      <td><input type="text" name="tb1_colunm13" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Receiver Position:</td>
      <td><input type="text" name="tb1_colunm14" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date Received:</td>
      <td><input type="date" name="tb1_colunm15" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Issued by:</td>
      <td><input type="text" name="tb1_colunm16" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Issuer Position:</td>
      <td><input type="text" name="tb1_colunm17" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date Issued:</td>
      <td><input type="date" name="tb1_colunm18" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Office:</td>
      <td><input type="text" name="tb1_colunm19" value="DENR MIMAROPA Region" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Age Quantity:</td>
      <td><input type="text" name="tb1_colunm21" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Age Value:</td>
      <td><input type="text" name="tb1_colunm22" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Remarks:</td>
      <td><input type="text" name="tb1_colunm23" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
    ...
    <!--<tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm25" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm26:</td>
      <td><input type="text" name="tb1_colunm26" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm27:</td>
      <td><input type="text" name="tb1_colunm27" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm28:</td>
      <td><input type="text" name="tb1_colunm28" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm29:</td>
      <td><input type="text" name="tb1_colunm29" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm30:</td>
      <td><input type="text" name="tb1_colunm30" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm31:</td>
      <td><input type="text" name="tb1_colunm31" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm32:</td>
      <td><input type="text" name="tb1_colunm32" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm33:</td>
      <td><input type="text" name="tb1_colunm33" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm34:</td>
      <td><input type="text" name="tb1_colunm34" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm35:</td>
      <td><input type="text" name="tb1_colunm35" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm36:</td>
      <td><input type="text" name="tb1_colunm36" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm37:</td>
      <td><input type="text" name="tb1_colunm37" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm38:</td>
      <td><input type="text" name="tb1_colunm38" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm39:</td>
      <td><input type="text" name="tb1_colunm39" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm40:</td>
      <td><input type="text" name="tb1_colunm40" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm41:</td>
      <td><input type="text" name="tb1_colunm41" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm42:</td>
      <td><input type="text" name="tb1_colunm42" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm43:</td>
      <td><input type="text" name="tb1_colunm43" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm44:</td>
      <td><input type="text" name="tb1_colunm44" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm45:</td>
      <td><input type="text" name="tb1_colunm45" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm46:</td>
      <td><input type="text" name="tb1_colunm46" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm47:</td>
      <td><input type="text" name="tb1_colunm47" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm48:</td>
      <td><input type="text" name="tb1_colunm48" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm49:</td>
      <td><input type="text" name="tb1_colunm49" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm50:</td>
      <td><input type="text" name="tb1_colunm50" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm51:</td>
      <td><input type="text" name="tb1_colunm51" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm52:</td>
      <td><input type="text" name="tb1_colunm52" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm53:</td>
      <td><input type="text" name="tb1_colunm53" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm54:</td>
      <td><input type="text" name="tb1_colunm54" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm55:</td>
      <td><input type="text" name="tb1_colunm55" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm56:</td>
      <td><input type="text" name="tb1_colunm56" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm57:</td>
      <td><input type="text" name="tb1_colunm57" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm58:</td>
      <td><input type="text" name="tb1_colunm58" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm59:</td>
      <td><input type="text" name="tb1_colunm59" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm60:</td>
      <td><input type="text" name="tb1_colunm60" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm61:</td>
      <td><input type="text" name="tb1_colunm61" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm62:</td>
      <td><input type="text" name="tb1_colunm62" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm63:</td>
      <td><input type="text" name="tb1_colunm63" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm64:</td>
      <td><input type="text" name="tb1_colunm64" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm65:</td>
      <td><input type="text" name="tb1_colunm65" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm66:</td>
      <td><input type="text" name="tb1_colunm66" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm67:</td>
      <td><input type="text" name="tb1_colunm67" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm68:</td>
      <td><input type="text" name="tb1_colunm68" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm69:</td>
      <td><input type="text" name="tb1_colunm69" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm70:</td>
      <td><input type="text" name="tb1_colunm70" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm71:</td>
      <td><input type="text" name="tb1_colunm71" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm72:</td>
      <td><input type="text" name="tb1_colunm72" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm73:</td>
      <td><input type="text" name="tb1_colunm73" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm74:</td>
      <td><input type="text" name="tb1_colunm74" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm75:</td>
      <td><input type="text" name="tb1_colunm75" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm76:</td>
      <td><input type="text" name="tb1_colunm76" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm77:</td>
      <td><input type="text" name="tb1_colunm77" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm78:</td>
      <td><input type="text" name="tb1_colunm78" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm79:</td>
      <td><input type="text" name="tb1_colunm79" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm80:</td>
      <td><input type="text" name="tb1_colunm80" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm81:</td>
      <td><input type="text" name="tb1_colunm81" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm82:</td>
      <td><input type="text" name="tb1_colunm82" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm83:</td>
      <td><input type="text" name="tb1_colunm83" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm84:</td>
      <td><input type="text" name="tb1_colunm84" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm85:</td>
      <td><input type="text" name="tb1_colunm85" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm86:</td>
      <td><input type="text" name="tb1_colunm86" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm87:</td>
      <td><input type="text" name="tb1_colunm87" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm88:</td>
      <td><input type="text" name="tb1_colunm88" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm89:</td>
      <td><input type="text" name="tb1_colunm89" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm90:</td>
      <td><input type="text" name="tb1_colunm90" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm91:</td>
      <td><input type="text" name="tb1_colunm91" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm92:</td>
      <td><input type="text" name="tb1_colunm92" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm93:</td>
      <td><input type="text" name="tb1_colunm93" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm94:</td>
      <td><input type="text" name="tb1_colunm94" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm95:</td>
      <td><input type="text" name="tb1_colunm95" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm96:</td>
      <td><input type="text" name="tb1_colunm96" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm97:</td>
      <td><input type="text" name="tb1_colunm97" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm98:</td>
      <td><input type="text" name="tb1_colunm98" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm99:</td>
      <td><input type="text" name="tb1_colunm99" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tb1_colunm100:</td>
      <td><input type="text" name="tb1_colunm100" value="" size="32" required /></td>
    </tr>-->
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" value="Continue" /></td>
