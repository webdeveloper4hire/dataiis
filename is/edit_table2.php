  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="tb2_colunm1" value="<?php echo htmlentities($row_rspayslip['tb2_colunm1'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm2:</td>
        <td><input type="text" name="tb2_colunm2" value="<?php echo htmlentities($row_rspayslip['tb2_colunm2'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm3:</td>
        <td><input type="text" name="tb2_colunm3" value="<?php echo htmlentities($row_rspayslip['tb2_colunm3'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm4:</td>
        <td><input type="text" name="tb2_colunm4" value="<?php echo htmlentities($row_rspayslip['tb2_colunm4'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm5:</td>
        <td><input type="text" name="tb2_colunm5" value="<?php echo htmlentities($row_rspayslip['tb2_colunm5'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm6:</td>
        <td><input type="text" name="tb2_colunm6" value="<?php echo htmlentities($row_rspayslip['tb2_colunm6'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm7:</td>
        <td><input type="text" name="tb2_colunm7" value="<?php echo htmlentities($row_rspayslip['tb2_colunm7'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm8:</td>
        <td><input type="text" name="tb2_colunm8" value="<?php echo htmlentities($row_rspayslip['tb2_colunm8'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm9:</td>
        <td><input type="text" name="tb2_colunm9" value="<?php echo htmlentities($row_rspayslip['tb2_colunm9'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm10:</td>
        <td><input type="text" name="tb2_colunm10" value="<?php echo htmlentities($row_rspayslip['tb2_colunm10'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm11:</td>
        <td><input type="text" name="tb2_colunm11" value="<?php echo htmlentities($row_rspayslip['tb2_colunm11'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm12:</td>
        <td><input type="text" name="tb2_colunm12" value="<?php echo htmlentities($row_rspayslip['tb2_colunm12'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm13:</td>
        <td><input type="text" name="tb2_colunm13" value="<?php echo htmlentities($row_rspayslip['tb2_colunm13'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm14:</td>
        <td><input type="text" name="tb2_colunm14" value="<?php echo htmlentities($row_rspayslip['tb2_colunm14'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Tb2_colunm15:</td>
        <td><input type="text" name="tb2_colunm15" value="<?php echo htmlentities($row_rspayslip['tb2_colunm15'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="tb2_colunm52" value="<?php echo htmlentities($row_rspayslip['tb2_colunm52'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
