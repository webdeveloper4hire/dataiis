...
<option value="Others">Others</option>
    ...
    <tr valign="baseline">
      ...
      <option value="BIGHANI M. MANIPULA, Ph.D.<br/>OIC, Assistant Regional Director<br/>Management Services">Assistant Regional Director Management Services</option>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm20" value="MARIA LOURDES G. FERRER, CESO III<br/>Regional Executive Director<br/><?php echo $clientbranch;?>" size="32" readonly/>
      </td>
    </tr>
    <tr valign="baseline">
