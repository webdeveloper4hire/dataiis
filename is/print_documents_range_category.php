...
$query_rstable1 = sprintf("SELECT * FROM table1 WHERE tb1_colunm1 = %s AND tb1_colunm2 = %s AND tb1_colunm3 = %s AND table1_id BETWEEN " . $_GET['start_id'] . " AND " . $_GET['end_id'] . " ORDER BY table1_id", GetSQLValueString($colname_rstable1, "text"),GetSQLValueString($colname2_rstable1, "text"),GetSQLValueString($colname3_rstable1, "text"));
