...
WHERE table2.tb2_colunm11 = '".$_GET['tb2_colunm11']."'
AND tb2_colunm4 LIKE '%".$_GET['date']."%'
";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="9" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - ROUTED BY <?php echo $_GET['tb2_colunm11']; ?> Received ON <?php echo $_GET['date']; ?> [<?php echo $totalRows_rstable1 ?>] </strong></td>
    </tr>
  <tr>
