...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10"><?php echo $_GET['tb1_colunm1'];?><small><?php echo $clientalias ;?> REGION</small> </h3>
            ...
            <div class="box-header">
              <a href="add_plans_programs.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>&type=refresh_id" class="button"><button type="submit"  class="btn denr-btn-primary">Add New <?php echo $_GET['tb1_colunm1'];?></button></a> <a href="select_filter_plans_programs.php?type=refresh_id" target="_blank" class="button"><button type="submit"  class="btn denr-btn-primary">Filter Data</button></a></p>
             
              <!--<p class="box-title"><a href="select_plans_programs_year.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>&type=refresh_id" class="button">
              <button type="submit"  class="btn denr-btn-primary">Summarize by Year</button></a></p>-->
...
<table class="display" id="datatables">
    ...
    <tbody>
      <?php do { ?>
        <tr>
          <td><a href="edit_table.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>">EDIT</a></td>
          <td><a href="delete_table1.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>" onclick="return confirm('Are you sure?')">DELETE</a></td>
