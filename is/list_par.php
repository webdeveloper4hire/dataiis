...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">Property Monitoring<small> <?php echo $clientalias ;?> REGION</small></h3>
</div>
            <div class="box-header">
              <a href="add_par.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>" class="button"><button type="submit"  class="btn denr-btn-primary">Add New <?php echo $_GET['tb1_colunm1'];?></button></a>
              
              <a href="#" class="button"><button type="submit"  class="btn denr-btn-primary">Print Summary</button></a>
...
<table class="display" id="datatables">
    ...
    <tbody>
      ...
      <td><a href="print_par_qr.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&data=PROPERTY No.:<?php echo $row_rstable1['tb1_colunm4']; ?> BY: <?php echo $row_rstable1['tb1_colunm13']; ?>" target="_blank">QR</a></td>
      <td><a href="add_par.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&tb1_colunm4=<?php echo $row_rstable1['tb1_colunm4']; ?>">Transfer</a></td>
      <td><a href="#">Print PAR</a></td>
