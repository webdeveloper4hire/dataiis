...
WHERE table2.tb2_colunm6 = '" . $_GET['tb2_colunm6'] . "'
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="9" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - ROUTED TO <?php echo $_GET['tb2_colunm6']; ?> FROM <?php echo $_GET['start']; ?> TO <?php echo $_GET['end']; ?> [<?php echo $totalRows_rstable1 ?>] </strong></td>
    </tr>
  <tr>
