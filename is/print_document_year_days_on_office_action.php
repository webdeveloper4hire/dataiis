...
$query_rstable1 = "SELECT table2.table2_id,table2.tb2_colunm2,table2.tb2_colunm3,table2.tb2_colunm4,table2.tb2_colunm6,table2.tb2_colunm7,table2.tb2_colunm9,tb2_colunm13,table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table1.tb1_colunm5 LIKE '%".$_GET['rdate']."%' GROUP BY table1_id ORDER BY table1_id DESC
";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="11" align="center"><strong>SUMMARIZED DOCUMENTS ACTED ON <?php echo $_GET['rdate']; ?> [<?php echo $totalRows_rstable1; ?> Documents Acted]</strong></td>
    </tr>
  <tr>
...
<?php if ($row_rstable1['tb1_colunm2'] != "0") {  ?><?php echo $row_rstable1['tb1_colunm2']; ?>-<?php } ?><?php echo $row_rstable1['tb1_colunm3']; ?>-<?php echo $row_rstable1['table1_id']; ?>
      ...
      <td><?php echo nl2br($row_rstable1['tb2_colunm9']); ?> by <?php echo $row_rstable1['tb2_colunm3']; ?> to <?php echo $row_rstable1['tb2_colunm6']; ?></td>
