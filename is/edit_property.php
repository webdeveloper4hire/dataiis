...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="date" name="tb1_colunm7" value="<?php echo htmlentities($row_rstable1['tb1_colunm7'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
	<tr valign="baseline">
	...
	<tr valign="baseline">
      ...
      <td><input type="date" name="tb1_colunm14" value="<?php echo htmlentities($row_rstable1['tb1_colunm14'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
	<tr valign="baseline">
	...
	<tr valign="baseline">
      ...
      <td><input type="date" name="tb1_colunm20" value="<?php echo htmlentities($row_rstable1['tb1_colunm20'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
	<tr valign="baseline">
