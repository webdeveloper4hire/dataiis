...
$query_rstable1 = sprintf("SELECT DISTINCT table2.tb2_colunm2, table2.tb2_colunm2, table2.tb2_colunm9, table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table1.tb1_colunm2 =  '" . $_GET['tb1_colunm2'] . "'
AND table1.tb1_colunm3 =  '" . $_GET['tb1_colunm3'] . "'
AND table2.tb2_colunm11 LIKE  '" . $_GET['user'] . "'
AND table1.table1_id BETWEEN  '" . $_GET['start_id'] . "' AND  '" . $_GET['end_id'] . "' ORDER BY table1_id ASC", GetSQLValueString($colname_rstable1, "text"),GetSQLValueString($colname2_rstable1, "text"));
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="10" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT FOR <?php echo date("d-M-Y"); ?> <!--DOC.NO. <?php echo $_GET['start_id'];?> to <?php echo $_GET['end_id'];?> --> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
