...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">List of <?php echo $_GET['tb1_colunm1']; ?></h3>
</div>
<?php if($_GET['tb1_colunm1'] == 'PR' ){ ?>
<a href="add_property.php?tb1_colunm1=PR"><input type="button" value="Add PR" class="btn denr-btn-primary"/></a>
 <? }?>
 <?php if($_GET['tb1_colunm1'] == 'iar' ){ ?>
<a href="add_property.php?tb1_colunm1=IAR"><input type="button" value="Add IAR" class="btn denr-btn-primary"/></a>
 <? }?>
<?php if($_GET['tb1_colunm1'] == 'ris' ){ ?>
<a href="add_property.php?tb1_colunm1=RIS"><input type="button" value="Add RIS" class="btn denr-btn-primary"/></a>
 <? }?>
<?php if($_GET['tb1_colunm1'] == 'ics' ){ ?>
<a href="add_property.php?tb1_colunm1=ICS"><input type="button" value="Add ICS" class="btn denr-btn-primary"/></a>
 <? }?>
<?php if($_GET['tb1_colunm1'] == 'PAR' ){ ?>
<a href="add_property.php?tb1_colunm1=PAR"><input type="button" value="Add PAR" class="btn denr-btn-primary"/></a>
<? }?>
...
<table class="display" id="datatables">
  ...
  <tr>
	...
	<?php if($_GET['tb1_colunm1'] == 'ris' ){ ?>
	 ...
	 <?}?>
	<?php if($_GET['tb1_colunm1'] == 'PR' || $_GET['tb1_colunm1'] == 'iar'  ){ ?>
    <td>Responsibility Center Code</td>
	<?}?>
	<?php if($_GET['tb1_colunm1'] == 'PR' ){ ?>
    <td>Date</td>
...
<!-- 
  ...
  <?php do { ?>
    <tr>
	<td><a href="print_<?php echo $_GET['tb1_colunm1'] ?>.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&tb1_colunm1=<?php echo $_GET['tb1_colunm1'] ?>" target="_blank">VIEW</a></td>
	  <td><a href="add_item.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&category=<?php echo $_GET['tb1_colunm1'] ?>&tb1_colunm1=item" target="_blank">ADD_ITEM</a></td>
      <td><a href="edit_property.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&tb1_colunm1=<?php echo $_GET['tb1_colunm1'] ?>" rel="facebox">UPDATE</a> <!--| <a href="add_item.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>&category=<?php echo $_GET['tb1_colunm1'] ?>&tb1_colunm1=item">TRANSFER</a>--></td>
