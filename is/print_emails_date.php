...
$query_rstable1 = "SELECT * FROM table1 WHERE tb1_colunm2 LIKE '".$_GET['category']."' AND tb1_colunm5 LIKE '%".$_GET['date']."%' ";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="8" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT FOR <?php echo $_GET['date']; ?> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
    ...
    <td><strong>____________</strong></td>
    <!--
    <td>tb1_colunm8</td>
    <td>tb1_colunm9</td>
    <td>tb1_colunm10</td>
