...
$query_rstable1 = "SELECT * FROM table1 WHERE tb1_colunm11 LIKE '%".$_GET['tb1_colunm11']."%' AND tb1_colunm21 LIKE '%".$_GET['date']."%' ";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="10" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT  FOR <?php echo $_GET['date']; ?> BY <?php echo $_GET['tb1_colunm11']; ?> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
  ...
  <?php do { ?>
    <tr valign="top" class="<?php echo $row_rstable1['table1_id']; ?>">
      <td <?php // echo "class=count"; ?>><span id="<?php echo $row_rstable1['table1_id']; ?>" title="Hide This"><?php echo $i++; ?></span>
<script> 
$(function(){ 
...
<?php if ($row_rstable1['tb1_colunm2'] != "0") {  ?><?php echo $row_rstable1['tb1_colunm2']; ?>-<?php } ?><?php echo $row_rstable1['tb1_colunm3']; ?>-<?php echo $row_rstable1['table1_id']; ?>
  ...
  if ($row_rstable1['tb1_colunm5'] == date("Y-m-d")) {
   ...
   ?></td>
      ...
      <td><?php if ($row_rstable1['tb1_colunm4'] == NULL) {echo $row_rstable1['tb1_colunm18'];} else {echo $row_rstable1['tb1_colunm4'];}?></div></td>
      <td><?php if ($row_rstable1['tb1_colunm6'] == NULL) {echo $row_rstable1['tb1_colunm18'];} else {echo $row_rstable1['tb1_colunm6'];}?></div></td>
