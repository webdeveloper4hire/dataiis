...
$query_rstable1 = "SELECT table2.tb2_colunm2, table2.tb2_colunm9, table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table2.tb2_colunm9 LIKE '%" . $_GET['tb2_colunm9'] . "%' AND table2.tb2_colunm13 LIKE '%" . $_GET['tb2_colunm13'] . "%' AND table1.tb1_colunm2 = '" . $_GET['tb1_colunm2'] . "' ";
