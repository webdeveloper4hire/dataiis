...
$query_rspayment = "SELECT * FROM table2 WHERE tb2_colunm52 LIKE '%".$_GET['tb2_colunm52']."%' ORDER BY table2_id ASC";
...
<p><a href="javascript:window.print()"><img src="../assets/b_print.png" /></a></p>
...
<table width="300px" border="1" cellspacing="0" cellpadding="5" class="jermar">
  ...
  <tr>
    <td><span class="surname"><?php echo $row_rspayment['tb2_colunm4']; ?>, <?php echo $row_rspayment['tb2_colunm3']; ?> <?php echo $row_rspayment['tb2_colunm5']; ?></span> <br /> <?php echo $row_rspayment['tb2_colunm7']; ?> <?php echo $row_rspayment['tb2_colunm6']; ?> SG-<?php echo $row_rspayment['tb2_colunm13']; ?> ST-<?php echo $row_rspayment['tb2_colunm14']; ?></td>
  ...
  <tr>
	...
	<tr>
    	<td>PERA: </td>
		<td align="right"><?php echo number_format($row_rspayment['tb2_colunm11'],2); ?></td></tr>
	<tr>
    	<td>ACTUAL: </td>
