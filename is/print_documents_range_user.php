...
$colname11_rstable1 = "-11";
if (isset($_GET['tb1_colunm11'])) {
  $colname11_rstable1 = $_GET['tb1_colunm11'];
}
mysql_select_db($database_connection, $connection);
$query_rstable1 = sprintf("SELECT * FROM table1 WHERE tb1_colunm1 = %s AND tb1_colunm3 = %s AND tb1_colunm11 = %s AND table1_id BETWEEN " . $_GET['start_id'] . " AND " . $_GET['end_id'] . "", GetSQLValueString($colname_rstable1, "text"),GetSQLValueString($colname3_rstable1, "text"),GetSQLValueString($colname11_rstable1, "text"));
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="10" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT  FOR <?php echo date("d-M-Y"); ?> <!--DOC.NO. <?php echo $_GET['start_id'];?> to <?php echo $_GET['end_id'];?> by <?php echo $row_rstable1['tb1_colunm11']; ?>--> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
...
$(function(){ 
   ...
   $("#<?php echo $row_rstable1['table1_id']; ?>").click(function(){ 
    ...
    $("#white").show(); 
      ...
      <td><?php echo $row_rstable1['tb1_colunm5']; ?> [<?php echo $row_rstable1['table1_id']; ?>]</td>
