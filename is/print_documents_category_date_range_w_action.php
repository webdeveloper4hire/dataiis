...
$query_rstable1 = "SELECT DISTINCT table2.tb2_colunm2, table2.tb2_colunm9, table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table1.tb1_colunm2 = '" . $_GET['tb1_colunm2'] . "'
AND table2.tb2_colunm7
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="11" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - CATEGORY(<?php echo $_GET['tb1_colunm2']; ?>) FROM <?php echo $_GET['start']; ?> TO <?php echo $_GET['end']; ?> [<?php echo $totalRows_rstable1 ?>] </strong></td>
    </tr>
  <tr>
...
$(function(){ 
   ...
   $("#<?php echo $row_rstable1['table1_id']; ?>").click(function(){ 
    ...
    $("#white").show(); 
      ...
      <td><a href="print_document.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>" target="_blank"><?php echo $row_rstable1['tb2_colunm9']; ?></a>
      </td>
      <td> </td>
      <!--
      <td>&nbsp;</td>
