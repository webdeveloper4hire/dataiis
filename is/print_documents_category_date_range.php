...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="10" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - CATEGORY(<?php echo $_GET['tb1_colunm2']; ?>) FROM <?php echo $_GET['start']; ?> TO <?php echo $_GET['end']; ?> [<?php echo $totalRows_rstable1 ?>] </strong></td>
    </tr>
  <tr>
