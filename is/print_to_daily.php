...
$query_rstable1 = "SELECT * FROM table1 WHERE tb1_colunm1 = '" . $_GET['tb1_colunm1'] . "' AND tb1_colunm22 LIKE '%" . $_GET['tb1_colunm22'] . "%' AND tb1_colunm2 IS NOT NULL";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar">
    <thead>
      <tr>
        <th colspan="11" align="center">REGIONAL TRAVEL ORDER SUMMARY REPORT FOR <?php echo date("d-M-Y"); ?></th>
      </tr>
      <tr>
    <th>T.O Number</th>
    <th>Name</th>
