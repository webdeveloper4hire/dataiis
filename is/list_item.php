...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">List of Item<small>
<?php //echo $count; ?> ONLINE
</small></h3>
</h3>
</div>
            <div class="box-header">
              <a href="add_items.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>&type=refresh_id" class="button" ><button type="submit"  class="btn denr-btn-primary">Add Item</button></a>
			   <a href="list_pr.php?tb2_colunm12=Request" class="button" ><button type="submit"  class="btn denr-btn-primary">Add New Request</button></a>
              ...
              <a href="../../archive" title="See old records here (2016-17)" target="_blank"><button type="submit" class="btn denr-btn-primary">Print RPCPPE Report</button></a>
              
              <div class="box-tools">
                <form name="search" action="search_documents.php" method="get">
                  <div class="input-group">
                    <input type="hidden" name="tb1_colunm1" value="Item">
...
<?php } elseif ($row_rstable1['tb1_colunm11'] == $_SESSION['MM_Username'] ) {?>
href="edit_document.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>"
<?php } else {}?>
...
href="delete_table.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>" onclick="return confirm('Are you sure?')"  <?php } ?> >DELETE</a></td>-->
          ...
          <td>
<?php echo $row_rstable1['table1_id']; ?>
</td>
