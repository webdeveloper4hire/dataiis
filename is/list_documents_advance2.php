...
$query_rstable1 = "SELECT table1.table1_id,table1.tb1_colunm2, table1.tb1_colunm3, table1.tb1_colunm4, table1.tb1_colunm5, table1.tb1_colunm6, table1.tb1_colunm7, table1.tb1_colunm8, table1.tb1_colunm9, table1.tb1_colunm10, table1.tb1_colunm11, table1.tb1_colunm17, table2.tb2_colunm3, table2.tb2_colunm6, table2.tb2_colunm9,MIN(table2.table2_id) FROM table1 LEFT JOIN table2 ON table1.table1_id=table2.tb2_colunm2 WHERE tb1_colunm1 = '".$_GET['tb1_colunm1']."' AND tb1_colunm5 LIKE '%".$_GET['tb1_colunm3']."%' GROUP BY table1_id";
...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10"><?php echo $_GET['tb1_colunm1'];?> <small><?php echo $clientalias ;?> REGION</small> </h3>
            ...
            <div class="box-header">
              ...
              <a href="select_document_range_category.php?tb1_colunm1=<?php echo $_GET['tb1_colunm1'];?>" rel="facebox"><button type="submit"  class="btn denr-btn-primary">Select Doc.No. and Category</button></a>
...
<table class="display" id="datatables">
    <thead>
      <tr>
        ...
        <th>16</th>
        <th>17</th>
        <th>18</th>best prezi presentation
        <th>19</th>
        <th>20</th>
        <th>21</th>
        <th>22</th>
...
href="edit_document.php?table1_id=<?php echo $row_rstable1['table1_id']; ?>"  <?php } ?> target="_blank">EDIT</a></td>
          <!--<td><a <?php
if ($row_rstable1['tb1_colunm11'] == $_SESSION['MM_Username'] ) { ?>   
