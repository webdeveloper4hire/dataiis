...
$query_rstable1 = "SELECT DISTINCT table2.tb2_colunm2, table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table2.tb2_colunm6 = '" . $_GET['tb2_colunm6'] . "' AND table1.tb1_colunm2 = '" . $_GET['tb1_colunm2'] . "'
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="9" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - CATEGORY(<?php echo $_GET['tb1_colunm2']; ?>) ROUTED TO <?php echo $_GET['tb2_colunm6']; ?> FROM <?php echo $_GET['start']; ?> TO <?php echo $_GET['end']; ?> [<?php echo $totalRows_rstable1 ?>] </strong></td>
    </tr>
  <tr>
