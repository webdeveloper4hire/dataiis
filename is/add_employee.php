...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "confirm_and_add.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm1" value="<?php echo $_GET['tb1_colunm1']; ?>" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm4" value="" size="32" required="required" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm5" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Step Increment:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">New Rate:</td>
    ...
    <tr valign="baseline">
      <td nowrap align="right">Item Number:</td>
      <td><input type="text" name="tb1_colunm15" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Status:</td>
      <td><select name="tb1_colunm16" ><option></option><option>Permanent</option><option>Coterminous</option></select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Civil Status:</td>
      <td><select name="tb1_colunm17" ><option></option><option>Single</option><option>Married</option><option>Widow</option></select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Entrance to Duty:</td>
      <td><input type="date" name="tb1_colunm18" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right">GSIS Policy No.:</td>
    ...
    <!--<tr valign="baseline">
      <td nowrap align="right">National Reference Card No:</td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="password" name="tb1_colunm26" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Access:</td>
      <td><input type="text" name="tb1_colunm27" value="2" size="32"></td>
    </tr>
    <tr valign="baseline">
