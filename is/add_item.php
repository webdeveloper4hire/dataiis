...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "redirect_add_item.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
	$category = $_GET['category'];
  }
  header(sprintf("Location: list_property.php?tb1_colunm1=$category"));
}

mysql_select_db($database_connection, $connection);
$query_rsitem = "SELECT DISTINCT tb1_colunm5 FROM table1 WHERE tb1_colunm1 = 'item'";
...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">Add <?php echo $_GET['tb1_colunm1']; ?> for <?php echo $_GET['category'];?></h3>
</div>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm2" readonly value="<?php echo $_GET['table1_id']; ?>" size="32" /></td>
    </tr>
	
	<?php if($_GET['category'] != 'ics' ) { ?>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Stock Property Number:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Item Desctription:</td>
      <td><input type="text" name="tb1_colunm5" value="" size="32" list="item" />
      <datalist id="item">
			<?php do { ?>
				<option value="<?php echo $row_rsitem['tb1_colunm5']; ?>">
	...
	<?php if($_GET['category'] == 'PR' || $_GET['category'] == 'ics' || $_GET['category'] == 'PAR') { ?>
    <tr valign="baseline">
	...
	<!--
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Total Cost:</td>
	...
	<?php if($_GET['category'] == 'ics') { ?>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Inventory Item No.:</td>
      <td><input type="text" name="tb1_colunm9" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Estimated Useful Time:</td>
      <td><input type="text" name="tb1_colunm10" value="" size="32" /></td>
    </tr>
	<?php }?>
	
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date Acquired:</td>
      <td><input type="date" name="tb1_colunm11" value="" size="32" /></td>
    </tr>
	<!--
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="date" name="tb1_colunm13" value="" size="32" /></td>
    </tr>
