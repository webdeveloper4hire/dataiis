...
$query_rstable1 = sprintf("SELECT * FROM table1 WHERE tb1_colunm3 = %s AND table1_id BETWEEN " . $_GET['start_id'] . " AND " . $_GET['end_id'] . "", GetSQLValueString($colname3_rstable1, "text"));
