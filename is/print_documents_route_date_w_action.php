...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="10" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - ROUTED TO <?php echo $_GET['tb2_colunm6']; ?> ON <?php echo $_GET['tb2_colunm7']; ?> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
  ...
  <?php do { ?>
    <tr valign="top" class="<?php echo $row_rstable1['table1_id']; ?>">
      <td <?php // echo "class=count"; ?>><?php echo $i++; ?><br />
      <?php echo $row_rstable1['tb2_colunm10']; ?></td>
      <td>
