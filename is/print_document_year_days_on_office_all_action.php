...
WHERE table1.tb1_colunm5 LIKE '%".$_GET['rdate']."%' ORDER BY table1_id DESC
";
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="11" align="center"><strong>SUMMARIZED DOCUMENTS ACTED ON <?php echo $_GET['rdate']; ?> [<?php echo $totalRows_rstable1; ?> Actions]</strong></td>
    </tr>
  <tr>
