...
<?php require_once('access_vouchers.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "redirect_print_vouchers.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<p><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="return confirm('Are you sure?')">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">MODE OF PAYMENT:</td>
  ...
  <option value="Others">Others</option>
    ...
    <tr valign="baseline">
      ...
      <td><input type="date" name="tb1_colunm4" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Payee/Office:</td>
      <td><input type="text" name="tb1_colunm5" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Check/ADA No.:</td>
      <td><input type="text" name="tb1_colunm6" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">OS/BUS No.:</td>
      <td><input type="text" name="tb1_colunm7" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb1_colunm8" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Responsibility:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">A. Certified:</td>
      <td><select name="tb1_colunm13">
        <option value="Supporting">Supporting</option>
        <option value="Cash-Available">Cash-Available</option>
        <option value="Subject-to-ADA-where applicable">Subject to ADA (where applicable)</option>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">B. Approved for Payment:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">C. Recieved Payment:</td>
      <td><input type="text" name="tb1_colunm26" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb1_colunm27" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Name:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb1_colunm30" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">OR No./ Other relevant:</td>
      <td><input type="text" name="tb1_colunm32" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">documents issued:</td>
      <td><input type="text" name="tb1_colunm33" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">D. Journal Entry:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb1_colunm36" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Status</td>
      <td><input type="text" name="tb1_colunm37" value="PENDING" size="32" readonly /></td>
    </tr>
    <tr valign="top">
      <td nowrap="nowrap" align="right">Remarks:</td>
      <td><textarea name="tb1_colunm38" cols="30" rows="5">
      </textarea>
      </td>
    </tr>
        <!--
