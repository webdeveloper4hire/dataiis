...
$query_rstable1 = sprintf("SELECT DISTINCT table2.tb2_colunm2,table2.tb2_colunm10, table1. * 
FROM table2
LEFT JOIN table1 ON table2.tb2_colunm2 = table1.table1_id
WHERE table2.tb2_colunm6 = %s AND table2.tb2_colunm7 LIKE %s", GetSQLValueString($colname_rstable1, "text"),GetSQLValueString("%" . $colname2_rstable1 . "%", "text"));
...
<table border="1" cellspacing="0" cellpadding="5"  class="jermar" id="datatables">
  <thead>
  <tr>
    <td colspan="9" align="center"><strong>REGIONAL DOCUMENT TRACKING SUMMARY REPORT - ROUTED TO <?php echo $_GET['tb2_colunm6']; ?> ON <?php echo $_GET['tb2_colunm7']; ?> [<?php echo $totalRows_rstable1 ?>]</strong></td>
    </tr>
  <tr>
  ...
  <?php do { ?>
    <tr valign="top" class="<?php echo $row_rstable1['table1_id']; ?>">
      <td <?php // echo "class=count"; ?> <?php
if ($row_rstable1['tb2_colunm10'] == "IN/Yellow Lane") {
    echo "bgcolor=#FFFF00";
}
elseif ($row_rstable1['tb2_colunm10'] == "OUT/Yellow Lane") {
    echo "bgcolor=#FFFF00";
}
elseif ($row_rstable1['tb2_colunm10'] == "IN/URGENT") {
	echo "bgcolor=#FF0000";
}
elseif ($row_rstable1['tb2_colunm10'] == "OUT/URGENT") {
	echo "bgcolor=#FF0000";
}
elseif ($row_rstable1['tb2_colunm10'] == "IN/DUE") {
    echo "bgcolor=#0000FF";
}
elseif ($row_rstable1['tb2_colunm10'] == "OUT/DUE") {
    echo "bgcolor=#0000FF";
}
else {
    echo "";
