...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">Add Leave</h3>
</div>
...
<div align="center">
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <table align="center">
                      ...
                      <tr valign="baseline">
                        <td colspan="2" align="center" nowrap><strong>Particulars</strong></td>
                      </tr>
                      <tr valign="baseline">
                        <td nowrap align="right">Days:</td>
                        <td><input type="number" name="tb2_colunm14" value="0" required></td>
                      </tr>
                      <tr valign="baseline">
                    ...
                    <input type="hidden" name="table2_id" value=""  required>
