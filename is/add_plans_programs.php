...
tb1_colunm7=eval(form.tb1_colunm7.value)
tb1_colunm8=eval(form.tb1_colunm8.value)
tb1_colunm9=eval(form.tb1_colunm9.value)
c=tb1_colunm7+tb1_colunm8+tb1_colunm9
form.tb1_colunm10.value=c
}
//-->
</SCRIPT>
</head>
...
<option value="2020">2020</option>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm2" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Project:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Personnel Services:</td>
      <td><input type="text" name="tb1_colunm7" value="0" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">M.O.O.E:</td>
      <td><input type="text" name="tb1_colunm8" value="0" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Capital Outlay:</td>
      <td><input type="text" name="tb1_colunm9" value="0" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Budget:</td>
      <td><input type="text" name="tb1_colunm10" onfocus="budget(this.form)" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Barangay:</td>
      <td><input type="text" name="tb1_colunm22" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Municipality:</td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm21" value="IV-B" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Responsible Division:</td>
      <td><input type="text" name="tb1_colunm20" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Output Indicator/UWM:</td>
      <td><input type="text" name="tb1_colunm12" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Target:</td>
      <td><input type="text" name="tb1_colunm13" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unit of Measure:</td>
      <td><input type="text" name="tb1_colunm14" value="" size="32" /></td>
    </tr>
    <tr valign="">
      <td nowrap="nowrap" align="right">Accomplishment:</td>
      <td><input type="text" name="tb1_colunm15" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Male Participants:</td>
      <td><input type="text" name="tb1_colunm18" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Female Participants:</td>
      <td><input type="text" name="tb1_colunm19" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb1_colunm16" value="<?php echo date("Y-m-d"); ?>" size="32" /></td>
    </tr>
    <tr valign="top">
      <td nowrap="nowrap" align="right">Remarks:</td>
      <td><textarea name="tb1_colunm17" rows="5" cols="30">
      </textarea></td>
    </tr>
    <!--
    <tr valign="baseline">
