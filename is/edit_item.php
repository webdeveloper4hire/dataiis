...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm2" value="<?php echo htmlentities($row_rstable1['tb1_colunm2'], ENT_COMPAT, 'utf-8'); ?>" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="top">
      ...
      <td><textarea name="tb1_colunm5" rows="5" cols="32"><?php echo htmlentities($row_rstable1['tb1_colunm5'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb1_colunm16" value="<?php echo htmlentities($row_rstable1['tb1_colunm16'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
