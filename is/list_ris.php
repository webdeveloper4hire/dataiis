...
$colname_rstable1 = "-1";
if (isset($_GET['tb2_colunm1'])) {
  $colname_rstable1 = $_GET['tb2_colunm1'];
}
mysql_select_db($database_connection, $connection);
$query_rstable1 = sprintf("SELECT * FROM table2 WHERE tb2_colunm1 = %s ORDER BY table2_id DESC", GetSQLValueString($colname_rstable1, "text"));
...
<div class="navbar-fixed-top body-title">    
	<h3 class="col-lg-10">Add Request & Issue Slip<small>
<?php //echo $count; ?> ONLINE
</small></h3>
</h3>
</div>
            <div class="box-header">
              <a href="add_pr.php?tb2_colunm1=<?php echo $_GET['tb2_colunm1'];?>&type=refresh_id" class="button" ><button type="submit"  class="btn denr-btn-primary">Add Request & Issue Slip</button></a>
